...
var Swiper = (function () {
    ...
    var H = {
        ...
        updateSlides: function () {
            ...
            ("string" == typeof x && x.indexOf("%") >= 0
                ...
                s.cssMode &&
                    (m(a, "--swiper-slides-offset-before", `${f}px`), m(a, "--swiper-slides-offset-after", `${v}px`)));
            ...
            for (let a = 0; a < c; a += 1) {
                ...
                if (!i || (P && e.grid.updateSlide(a, i, d), "none" !== y(i, "display"))) {
                    if (l && "auto" === s.slidesPerView)
                        ...
                        if (
                            (r && (i.style.transform = "none"), n && (i.style.webkitTransform = "none"), s.roundLengths)
                        )
            ...
            if (
                ...
                if (a) {
                    ...
                    if ("auto" === s.slidesPerView) {
                        e = 1;
                        let t = 0;
                        for (let s = h.length - 1; s >= 0 && ((t += h[s] + (s < h.length - 1 ? x : 0)), t <= E); s -= 1)
                            e = h.length - s;
    ...
    function U() {
        ...
        if (
            ...
            e.params.loop && !n ? e.slideToLoop(e.realIndex, 0, !1, !0) : e.slideTo(e.activeIndex, 0, !1, !0);
        else {
    ...
    const be = [
        ...
        function ({ swiper: e, extendParams: t, on: s, emit: i }) {
            ...
            ((e.keyboard = { enabled: !1 }),
                t({ keyboard: { enabled: !1, onlyInViewport: !0, pageUpDown: !0, speed: void 0 } }),
                s("init", () => {
        ...
        function ({ swiper: e, extendParams: t, on: s, emit: a }) {
            ...
            Object.assign(e.pagination, {
                enable: () => {
                    ...
                    let { el: t } = e.pagination;
                    (t &&
                        ((t = M(t)), t.forEach((t) => t.classList.remove(e.params.pagination.paginationDisabledClass))),
                        u(),
                        p(),
                        c());
                },
            ...
            const y = (e, t, s) => {
                ...
                C = (t) => {
                    ...
                    const a = e.virtual && e.params.virtual.enabled,
                        n =
                            (a ? parseInt(s.getAttribute("data-swiper-slide-index"), 10) : e.slides.indexOf(s)) ===
                            e.activeIndex,
                ...
                L = () => {
                    ...
                    t.slideLabelMessage &&
                        e.slides.forEach((a, i) => {
                            ...
                            m(
                                a,
                                t.slideLabelMessage.replace(/\{\{index\}\}/, r + 1).replace(/\{\{slidesLength\}\}/, s),
                            );
                        });
                },
                I = () => {
                    ...
                    if (
                        ((o = M(o)),
                        (d = M(d)),
                        o && o.forEach((e) => y(e, 0, t.nextSlideMessage)),
                        d && d.forEach((e) => y(e, 0, t.prevSlideMessage)),
                        b())
                    ) {
        ...
        function ({ swiper: e, extendParams: t, on: s, emit: i, params: r }) {
            ...
            const b = () => {
                            ...
                            e &&
                                ...
                                (e.params.autoplay.reverseDirection
                                    ...
                                    : !e.isEnd || e.params.loop || e.params.rewind
                                      ...
                                      : e.params.autoplay.stopOnLastSlide || (e.slideTo(0, a, !0, !0), i("autoplay")),
                                e.params.cssMode &&
                                    ((v = new Date().getTime()),
                                    requestAnimationFrame(() => {
                                        E();
                ...
                x = () => {
                    ((v = new Date().getTime()), (e.autoplay.running = !0), E(), i("autoplayStart"));
                },
                S = () => {
                ...
                C = () => {
                    if (e.destroyed || !e.autoplay.running) return;
                    const t = a();
                    ("hidden" === t.visibilityState && ((m = !0), T(!0)), "visible" === t.visibilityState && M());
                },
                P = (t) => {
                    "mouse" === t.pointerType && ((m = !0), (h = !0), e.animating || e.autoplay.paused || T(!0));
                },
                L = (t) => {
            ...
            (s("init", () => {
                ...
                s("slideChange", () => {
                    !e.destroyed && e.autoplay.running && e.autoplay.paused && ((o = y()), (f = y()));
                }),
        ...
        function ({ swiper: e, extendParams: t, on: s }) {
            ...
            function d(t, s) {
                ...
                if (
                    ...
                    for (let t = 0; t < i; t += 1)
                        g(a.slidesEl, `[data-swiper-slide-index="${e.realIndex + t}"]`).forEach((e) => {
                            e.classList.add(r);
                        });
                else
                    for (let t = 0; t < i; t += 1)
                        a.slides[e.realIndex + t] && a.slides[e.realIndex + t].classList.add(r);
                (s?.autoScroll ?? 1) &&
                    (function (t) {
                        ...
                        if (e.realIndex !== s.realIndex || r) {
                            ...
                            if (s.params.loop) {
                                ...
                                ((l = s.slides.indexOf(t)), (o = e.activeIndex > e.previousIndex ? "next" : "prev"));
                            } else ((l = e.realIndex), (o = l > e.previousIndex ? "next" : "prev"));
                            (r && (l += "next" === o ? i : -1 * i),
                                s.visibleSlidesIndexes &&
                                    s.visibleSlidesIndexes.indexOf(l) < 0 &&
                                    (s.params.centeredSlides
                                        ? (l = l > n ? l - Math.floor(a / 2) + 1 : l + Math.floor(a / 2) - 1)
                ...
                (e.grid = {
                    initSlides: (t) => {
                        ...
                        ((r = Math.floor(o / n)),
                            ...
                            "auto" !== s && "row" === l && (a = Math.max(a, Math.floor(s) * n)),
                            (i = a / n));
                    },
                    unsetSlides: () => {
                        e.slides &&
