...
SYSTEM_SETTINGS_MODULES: list[dict[str, Any]] = [
    ...
    {
        "code": "MULTI_CHANNEL_NOTIFICATIONS",
        "title": "Alerts & Notifications",
        "title_th": "การแจ้งเตือนหลายช่องทาง",
        "icon": "fa-solid fa-bell",
        "url": "/page?page=system_config#tab=notifications",
        "tab": "notifications",
    },
]

# ---------------------------------------------------------------------------
# 🏷️ SYSTEM MENU CATEGORIES (Sub-categorization for Access Control & Modules)
# ---------------------------------------------------------------------------
SYSTEM_MENU_CATEGORIES: list[dict[str, Any]] = [
    {
        "code": "identity",
        "title": "Identity & Credentials",
        "title_th": "ข้อมูลประจำตัวและบัตรผ่าน",
    ...
    },
    {
        ...
        "title_th": "จุดเข้า-ออกและอุปกรณ์",
...
SYSTEM_MENU_REGISTRY: list[dict[str, Any]] = [
    ...
    # --- 🛡️ Access Control: Identity & Credentials ---
    {
        "code": "MEMBERS",
        "page": "members",
        "title": "Cardholders",
    ...
    # --- 🛡️ Access Control: Doors & Hardware ---
    {
        "code": "DOORS",
        "page": "doors",
        "title": "Doors & Gates",
    ...
    },
    {
        ...
        "title_th": "อุปกรณ์อ่านบัตร (Readers)",
        "url": "/page?page=devices",
        "icon": "fa-solid fa-microchip",
        "category": "access",
        "group": "hardware",
        "badge": "DEV",
        "default_for_new_role": True,
        "description": "Manage card readers, biometric scanners, face kiosks, and terminals",
    },
    {
        "code": "ZONES",
        "page": "zones",
    ...
    # --- 🛡️ Access Control: Rules & Policies ---
    {
        "code": "ACCESS_GROUPS",
        "page": "access_groups",
        "title": "Access Groups",
